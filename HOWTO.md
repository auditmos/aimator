...
Repo dostarcza skille Claude Code w `.claude/skills/`, na te fragmenty pracy, których
...
- **Implementacja**: TDD pionowymi plastrami, czyli jeden czerwony test, minimalny kod, refaktor,
  od nowa
- **Commit**: powiedz `commit this` albo użyj wbudowanego `/commit`

Pełny proces produkcyjny opisuje [README.md](README.md), a kontrakt etapów opisuje
