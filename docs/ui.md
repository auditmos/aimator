...
Bez akcji: w tej wersji nic się stąd nie uruchamia i nic nie zatwierdza. Panele etapów,
podgląd artefaktów i płatne akcje w dwóch krokach to kolejne wycinki.
...
`list --json`, odmowa zostaje odmową z tym samym komunikatem, a strumień zdarzeń wypycha
drabinę po zmianie pliku. Klient jest sprawdzany w przeglądarce, w obu motywach.
