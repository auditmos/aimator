...
decyzją.** Klucze czytane są wyłącznie na ścieżce płatnej — `--dry-run` nie sięga po
sekret ani po sieć.
...
Klip nie jest rysowany — jest renderowany z klatki, którą ten tor już wyprodukował, więc
osią jest miejsce wywołania, nie tor.

## Czego tu nie ma

**Głosu narratora.** Kto czyta serię, to obsada — wraca między odcinkami tak samo jak
