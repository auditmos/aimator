...
`<tor>/mixed.mp4` — film ze wszystkim.
...
| **Bramka** | zatwierdzony [etap 3](03-lista-ujec.md); miks — zgoda na `narrated.mp4` |
...
Mieszkają w `projects/<id>/mix.json` — nie w `project.json`, bo suwak unieważniałby zgody
