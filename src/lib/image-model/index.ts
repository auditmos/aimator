 ...
 * copies had already drifted apart in their comments. Stage 7 is not a fourth
 * caller: a video clip is an asynchronous job with an id to poll, which is a
 * different lifecycle and will get its own module rather than a flag in this
 * one.
 *
