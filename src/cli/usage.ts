...
const FLAGS = `  --audio      music-and-effects | dialogue | narration | dialogue-and-narration
  ...
  --json       obiekt etapu zamiast tekstu, z polem command i stage; na check
               ...
               shot-list, prompt-package, character, references, opening-frame,
               clips, assembly albo soundtrack, a z komend etapu na razie
               wyłącznie na etapach 0–9; kolejne etapy dostają go po kolei
               razem ze swoim panelem w UI
